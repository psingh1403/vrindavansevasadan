    ...
    <main>
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active">
                <div class="single-slider  hero-overly slider-height d-flex align-items-center" data-background="assets/img/hero/langingimage.jpg" >
                    <div class="container">
                        <div class="row justify-content-center text-center">
                            <div class="col-xl-10">
                                <div class="h1-slider-caption">
                                    <h1 data-animation="fadeInUp" data-delay=".4s">Welcome To Our World</h1>
                                    <h3 data-animation="fadeInDown" data-delay=".4s" style="word-spacing: 16px; margin-bottom: 22px !important;">VRINDAVAN SEVA SADAN</h3>
                                    <h4 data-animation="fadeInDown" data-delay=".4s" style="word-spacing: 4px;color:#fff; text-transform: uppercase;">Thakur Shree Radha Bihari Charitable Trust</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                   <div class="col-xl-5 col-lg-6">
                        <div class="customer-img mb-120">
                            <img src="assets/img/customer/customar1.jpg" class="customar-img1" alt="">
                            <img src="assets/img/customer/customar2.png" class="customar-img2" alt="">
                            <div class="service-experience heartbeat">
                                <h3>7 Years of Service<br>Experience</h3>
                            </div>
                        </div>
                   </div>
        ...
        <!-- Room Start -->
        <section class="room-area" style="background-color: #c7ceeb">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <!--font-back-tittle  -->
                        <div class="font-back-tittle mt-45 mb-45 ">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="single-room mb-50">
                            <div class="room-img">
                               <img src="assets/img/rooms/room11.jpg" alt="">
                            </div>
                            <div class="room-caption">
                                <h3>Superiur Room With Double Bed</h3>
                                <div class="per-night">
                                    <span>RS: 900 <span>/ par night</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="single-room mb-50">
                            <div class="room-img">
                               <img src="assets/img/rooms/room12.jpg" alt="">
                            </div>
                            <div class="room-caption">
                                <h3>Single Room With Single Bed</h3>
                                <div class="per-night">
                                    <span>RS: 700 <span>/ par night</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="single-room mb-50">
                            <div class="room-img">
                               <img src="assets/img/rooms/room13.jpg" alt="">
                            </div>
                            <div class="room-caption">
                                <h3>Deluxe Room With Double Bed</h3>
                                <div class="per-night">
                                    <span>RS: 800 <span>/ par night</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="single-room mb-50">
                            <div class="room-img">
                                <img src="assets/img/rooms/room15.jpg" alt="">
                            </div>
                            <div class="room-caption">
                                <h3>Single Room With Single Bed</h3>
                                <div class="per-night">
                                    <span>RS: 600 <span>/ par night</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="single-room mb-50">
                            <div class="room-img">
                                <img src="assets/img/rooms/room14.jpg" alt="">
                            </div>
                            <div class="room-caption">
                                <h3>Deluxe Room With Double Bed</h3>
                                <div class="per-night">
                                    <span>RS: 1200 <span>/ par night</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        ...
                        <div class="single-room mb-50">
                            <div class="room-img">
                               <img src="assets/img/rooms/room16.jpg" alt="">
                            </div>
                            <div class="room-caption">
                                <h3>Superiur Room With Double Bed</h3>
                                <div class="per-night">
        ...
        <div class="container" style="margin-top: 60px;">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <img src="assets/img/dining/bar.jpg" style="width: 100%; margin-bottom: 15px;">
                    <h3>Our Resturent</h3>
                    <p>a place where cooked food is sold to the public, and where people sit down to eat it. It is also a place where people go to enjoy the time and to eat a meal. Some restaurants are a chain, meaning that there are restaurants which have the same name and serve the same food.</p>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <img src="assets/img/dining/dining-img2.jpg" style="width: 100%; height: 393px; margin-bottom: 15px;">
                    <h3>Swimming Pool</h3>
                    <p>swimming pool is a large hole in the ground that has been made and filled with water so that people can swim in it. The hotel has a heated indoor swimming pool. Our swimming pool is available for fun or exercise. The outdoor swimming pool is open during the summer months.</p>
                </div>
            </div>
        </div>
        <!-- Dining End -->
        ...
        <!-- Gallery img Start-->
        <div class="gallery-area fix mt-5">
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-md-12">
                        <div class="gallery-active owl-carousel">
                            <div class="gallery-img">
                                <a href="#"><img src="assets/img/slider/gallery1.jpg" alt="" height="290"></a>
                            </div>
                            <div class="gallery-img">
                                <a href="#"><img src="assets/img/slider/gallery2.jpg" alt="" height="290"></a>
                            </div>
                            <div class="gallery-img">
                                <a href="#"><img src="assets/img/slider/gallery3.jpg" alt="" height="290"></a>
                            </div>
                        </div>
                    </div>
                </div>
