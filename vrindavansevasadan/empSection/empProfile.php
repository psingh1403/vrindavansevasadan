   ...
   <body>
    ...
    <main>
        ...
        <div class="content">
            ...
            // SELECT `emp_id`, `emp_name`, `emp_username`, `emp_phone`, `emp_email`, `emp_address`, `emp_city`, `emp_state`, `emp_dept`, `emp_doj`, `emp_dob`, `emp_password` FROM `employee` WHERE 1
            ...
            $run = mysqli_query($con,$sql);
             ...
             ?>
            <form class="userprofileform" action="#" enctype="multipart/form-data">
                <p class="mb-5">Note: Only admin can change your information.</p>
                <div class="form-group">
                    <label>Name:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['emp_name']; ?>">
                </div>
                <div class="form-group">
                    <label>User Name:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['emp_username']; ?>">
                </div>
                <div class="form-group">
                    <label>Phone:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['emp_phone']; ?>">
                </div>
                <div class="form-group">
                    <label>Email:</label>
                    <input type="email" disabled class="form-control" value="<?php echo $row['emp_email']; ?>">
                </div>
                <div class="form-group">
                    <label>Address:</label>
                    <textarea disabled class="form-control" rows="6" style="max-height: 160px;"><?php echo $row['emp_address']; ?></textarea>
                </div>
                <div class="form-group">
                    <label>City:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['emp_city']; ?>">
                </div>
                <div class="form-group">
                    <label>State:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['emp_state']; ?>">
                </div>
                <div class="form-group">
                    <label>Department:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['emp_dept']; ?>">
                </div>
                <div class="form-group">
                    <label>Date of Birth:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['emp_dob']; ?>">
                </div>
                <div class="form-group">
                    <label>Date of Joining:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['emp_doj']; ?>">
                </div>
            </form>
            <?php }} ?>
