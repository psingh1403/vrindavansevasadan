...
<html class="no-js" lang="zxx">
   ...
   <body>
    ...
    <main>
        ...
        $sql1 = "SELECT `id`, `emp_id`, `emp_name`, `emp_phone`, `emp_email`, `start_date`, `end_date`, `emp_reason`, `emp_explain`, `approved` FROM `employeeleave` WHERE `emp_id` = $empid";
        $run1 = mysqli_query($con,$sql1);
         ?>
        <div class="content">
            <div class="container">
                <h1>All Leaves Applications</h1>
                <table class="table table-responsive mt-5">
                    ...
                    <tr>
                        ...
                        <td><?php echo $row1['emp_reason']; ?></td>
                        <td><?php if ($row1['approved'] == 'approved') {
                            echo "<button disabled class='btn btn-success'>approved</button>";
                        }else{
