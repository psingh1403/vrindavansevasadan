    ...
    <main>
                   ...
                   <div class="col-xl-5 col-lg-6">
                        <div class="customer-img mb-120">
                            ...
                            <!-- <div class="service-experience heartbeat">
                                <h3>15 Years of Service<br>Experience</h3>
                            </div> -->
                        </div>
                   </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <img src="assets/img/dining/aboutphoto1.jfif" width="100%">
                </div>
            </div>
            <div class="row" style="margin-top: 40px; margin-bottom: 40px;">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <img src="assets/img/dining/restaurant.jpg" width="100%">
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12" style="margin-top: 120px;">                    
                    <h3>Our resturent</h3>
            ...
            <div class="row" style="margin-top: 40px; margin-bottom: 40px;">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12"">    
                    <img src="assets/img/dining/swimmingpool.jpg" width="100%">
                </div>
            </div>
        </div>
