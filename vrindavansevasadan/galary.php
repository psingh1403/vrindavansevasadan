            ...
            <div class="container">
                <div class="row mt-45 mb-45">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-40">
                        <h2 style="text-align: center;">Welcome to our Hotel Photo Gallery</h2>
                    </div>
                </div>
                
                <h4 class="mt-45 mb-45">HOTEL ROOMS:</h4>
                <div class="row mb-40">
                    <div class="col-xl-4 col-lg-4 mb-40 justify-content-center">
                        <img src="galaryimg/room1.jpeg" height="220" width="300">
                    </div>
                    <div class="col-xl-4 col-lg-4 mb-40 justify-content-center">
                        <img src="galaryimg/room2.jpeg" height="220" width="300">
                    </div>
                    <div class="col-xl-4 col-lg-4 mb-40 justify-content-center">
                        <img src="galaryimg/room3.jpeg" height="220" width="300">
                    </div>
                </div>
                <div class="row row mb-40">
                    <div class="col-xl-4 col-lg-4 mb-40 justify-content-center">
                        <img src="galaryimg/room4.jpeg" height="220" width="300">
                    </div>
                    <div class="col-xl-4 col-lg-4 mb-40 justify-content-center">
                        <img src="galaryimg/room5.jpeg" height="220" width="300">
                    </div>
                    <div class="col-xl-4 col-lg-4 mb-40 justify-content-center">
                        <img src="galaryimg/room6.jpeg" height="220" width="300">
                    </div>
                </div>
                <h4 class="mt-45 mb-45">HOTEL SWIMMING POOL:</h4>
                <div class="row mb-40">
                    <div class="col-xl-6 col-lg-6 mb-40 justify-content-center">
                        <img src="galaryimg/pool1.jpg" height="320" width="435">
                    </div>                    
                    <div class="col-xl-6 col-lg-6 mb-40 justify-content-center">
                        <img src="galaryimg/pool2.jpg" height="320" width="435">
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-6 col-lg-6 mb-40 justify-content-center">
                        <img src="galaryimg/pool3.jpg" height="320" width="435">
                    </div>
                    <div class="col-xl-6 col-lg-6 mb-40 justify-content-center">
                        <img src="galaryimg/pool4.jpg" height="320" width="435">
                    </div>
                </div>
                <h4 class="mt-45 mb-45">HOTEL PARKING:</h4>
                <div class="row mb-40">
                    <div class="col-xl-6 col-lg-6 mb-40 justify-content-center">
                        <img src="galaryimg/parking1.jpg" height="320" width="435">
                    </div>                    
                    <div class="col-xl-6 col-lg-6 mb-40 justify-content-center">
                    <img src="galaryimg/parking2.jpg" height="320" width="435">
                        
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-6 col-lg-6 mb-40 justify-content-center">
                        <img src="galaryimg/parking3.jpg" height="320" width="435">
                    </div>
                    <div class="col-xl-6 col-lg-6 mb-40 justify-content-center">
                        <img src="galaryimg/parking4.jpg" height="320" width="435"> 
                    </div>
                </div>
