        ...
        <div class="content">
            ...
            <form class="userprofileform" action="#" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <?php if ($row['u_img'] == "") {
                        echo "<img src='image/profile2.jpg' width='155' height='155'>";
                    }else{ ?>
                ...
                <div class="form-group">
                    <label>Name:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['fullname']; ?>">
                </div>
                <div class="form-group">
                    <label>User Name:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['username']; ?>">
                </div>
                <div class="form-group">
                    <label>Phone:</label>
                    <input type="text" disabled class="form-control" value="<?php echo $row['phone']; ?>">
                </div>
                <div class="form-group">
                    <label>Email:</label>
                    <input type="email" disabled class="form-control" value="<?php echo $row['email']; ?>">
                </div>
                <div class="form-group">
                    <label>Adhar Number:</label>
                    <input type="email" disabled class="form-control" value="<?php echo $row['adhar']; ?>">
                </div>
            
                <!-- <button class="btn btn-primary">Submit</button> -->
                <a href="editProfile.php?id=<?php echo $row['u_id']; ?>" class="btn btn-primary">Edit My Profile</a>
