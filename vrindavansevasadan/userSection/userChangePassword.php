...
<html class="no-js" lang="zxx">
   ...
   <body>
    ...
    <main>
        ...
        <div class="sidebar">
            <!-- <a href=""><img src="image/<?php //echo $_SESSION['uimg'];?>" style=""></a> -->
            <!-- <a href="#">Home</a> -->
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12 mx-auto form p-4">
                        <form action="#" method="post">
                            ...
                            <div class="float-right">
                                <button type="submit" name="userChangePass" class="btn btn-primary">Change</button>
                            </div>
                        </form>
                    </div>
                </div>
...
if (isset($_POST['userChangePass'])) {
    ...
    $user_new_pass = $_POST['ConfPassword'];

    $sql = "SELECT `username`, `email`, `password` FROM `login` WHERE `username` = '$user_user' AND `email` = '$user_email' AND `password` = '$user_pass'";

    $run = mysqli_query($con,$sql);
    if (mysqli_num_rows($run) < 1) {
        echo "<script>alert('Check your username and email...');</script>";
    }else{
        $quy = "UPDATE `login` SET `password`='$user_new_pass' WHERE u_id = $user_id";
        mysqli_query($con,$quy);
        echo "<script>alert('Your Password has been successfully updated thank you...');window.open('userMyprofile.php','_self');</script>";
    }
}
